...
exports.translateThemeConfig = exports.getTranslationFiles = void 0;
...
function getNavbarTranslationFile(navbar) {
  ...
  const navbarItemsTranslations = Object.fromEntries(
    allNavbarItems
...
function getFooterTranslationFile(footer) {
  const footerLinkTitles = Object.fromEntries(
  ...
  const footerLinkLabels = Object.fromEntries(
    (isMultiColumnFooterLinks(footer.links)
...
function translateThemeConfig({ themeConfig, translationFiles }) {
  const translationFilesMap = lodash_1.default.keyBy(
    translationFiles,
    (f) => f.path
  );
  return {
