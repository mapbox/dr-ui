...
exports.validateOptions =
  ...
  exports.getSwizzleConfig =
  exports.AnnouncementBarDismissStorageKey =
    void 0;
...
const requireFromDocusaurusCore = (0, module_1.createRequire)(
...
function themeMapbox(context, options) {
  const {
  ...
  return {
    ...
    getTranslationFiles: () =>
      (0, translations_1.getTranslationFiles)({ themeConfig }),
    translateThemeConfig: (params) =>
      (0, translations_1.translateThemeConfig)({
    ...
    getClientModules() {
      const modules = ['./prism-include-languages', './nprogress'];
      modules.push(
        ...customCss.map((p) => path_1.default.resolve(context.siteDir, p))
      );
      return modules;
    },
    configureWebpack() {
...
Object.defineProperty(exports, 'validateThemeConfig', {
  enumerable: true,
  get: function () {
    return options_1.validateThemeConfig;
  }
});
Object.defineProperty(exports, 'validateOptions', {
  enumerable: true,
  get: function () {
    return options_1.validateOptions;
  }
});
