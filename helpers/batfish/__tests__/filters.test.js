...
describe('hasTopic', () => {
  it('works', () => {
    ...
    }, 'Getting started')).toBeTruthy();
    expect(hasTopic({
      topics: ['Getting started']
    }, 'Getting started')).toBeTruthy();
    expect(hasTopic({
      topics: ['Getting started', 'Map design']
    }, 'Getting started')).toBeTruthy();
    expect(hasTopic({
      topics: ['Getting started', 'Map design']
    }, 'Carrots')).not.toBeTruthy();
  });
});
describe('combineArrays', () => {
  it('sorted and unique', () => {
    expect(combineArrays([{
      ...
      language: ['No code']
    }], 'language')).toEqual(['Java', 'JavaScript', 'Kotlin', 'No code']);
  });
});
describe('generateLevels', () => {
  it('sorted and unique', () => {
    expect(generateLevels([{
      level: 2
    }, {
      level: 1
    }, {
