...
const trafficV1 = {
  ...
  layers: [{
    ...
    paint: {
      'line-width': 1.5,
      'line-color': ['case', ['==', 'low', ['get', 'congestion']], brandColors.blueLight.fullOpacity, ['==', 'moderate', ['get', 'congestion']], brandColors.blue.fullOpacity, ['==', 'heavy', ['get', 'congestion']], brandColors.pink.fullOpacity, ['==', 'severe', ['get', 'congestion']], brandColors.pinkDark.fullOpacity, brandColors.black.fullOpacity]
    }
  }]
};
