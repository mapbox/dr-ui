...
describe('peerDependencies are up-to-date', () => {
  ...
  test(`react`, () => {
    expect(devDependencies['react'] === peerDependencies['react']).toBeTruthy();
  });

  test(`react-dom`, () => {
    expect(
      devDependencies['react-dom'] === peerDependencies['react-dom']
    ).toBeTruthy();
  });

  test(`@mapbox/mr-ui`, () => {
    expect(
      dependencies['@mapbox/mr-ui'] === peerDependencies['@mapbox/mr-ui']
    ).toBeTruthy();
  });
