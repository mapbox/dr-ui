...
export default class Plugins extends React.PureComponent {
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    }, entries(this.props.pluginData).map(([title, plugins], i) => /*#__PURE__*/React.createElement("div", {
      key: i
      ...
      className: "pb24"
    }, md(plugins.description)), entries(plugins.plugins).map(([name, plugin], i) => /*#__PURE__*/React.createElement("div", {
      key: i,
