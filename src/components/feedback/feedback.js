...
Feedback.propTypes = {
  ...
  /** The name of section the feedack component falls under */
  section: PropTypes.string,
  /** This prop is generated by batfish and provides context for the current page */
  ...
  /** The preferred code language if available */
  preferredLanguage: PropTypes.string,
  /** The Sentry DSN (URL) to send text feedback to for issue management or "false" to not send feedback to Sentry */
  feedbackSentryDsn: PropTypes.oneOfType([PropTypes.string, PropTypes.bool]),
  /** Position of the feedback component on the page, this value creates unique `id` attributes */
