...
// but actually, DON'T import plugins. it should be a prop
                ...
                >
                    {entries(plugins).map(([title, plugins], i) => (
                        <div key={i}>
                            ...
                            <div className="pb24">
                                {md(plugins.description)}
                            </div>
                            {entries(plugins.plugins).map(
                                ([name, plugin], i) => (
                                    <div
                                        key={i}
