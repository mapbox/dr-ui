    ...
    _defineProperty(this, "editButtons", () => {
      ...
      if (jsxEdit) {
        return /*#__PURE__*/React.createElement(EditWrapper, {
          maxHeight: maxHeight
        }, /*#__PURE__*/React.createElement(JSXEdit, {
          code: code
        }));
      }
      return edit && edit.html && edit.js && edit.frontMatter.title && edit.frontMatter.description ? /*#__PURE__*/React.createElement(EditWrapper, null, /*#__PURE__*/React.createElement(Edit, {
        css: edit.css,
        html: edit.html,
        js: edit.js,
        head: edit.head,
