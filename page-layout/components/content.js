...
export class ContentWrapper extends React.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "renderAside", showFeedback => {
      const {
        frontMatter,
        layoutConfig
      } = this.props;
      ...
      }, /*#__PURE__*/React.createElement(DiscordCTA, null)), showFeedback && /*#__PURE__*/React.createElement("div", {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "grid grid--gut60 mb120"
      ...
      className: "w-full w-1/2-ml px6 flex-child-no-shrink mb18"
    }, /*#__PURE__*/React.createElement(DiscordCTA, null))), this.renderFeedback()))));
  }
}